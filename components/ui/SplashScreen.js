...
//       }, 3000); // FIXED: Locked to exactly 3.0 seconds
//       return () => clearTimeout(timer);
//     }
//   }, []);

//   // Updated variant for authentic "drawing/painting" effect
//   const pathVariants = {
//     hidden: {
//       pathLength: 0,
//       fillOpacity: 0,
...
//       fillOpacity: 1,
//       transition: {
//         // The line takes 1.4 seconds to outline the shape smoothly
//         pathLength: { duration: 1.4, ease: "easeInOut" },
//         // The fill paint bleeds in smoothly just as the drawing finishes
...
//         <motion.div
//           initial={{ opacity: 1 }}
//           exit={{ opacity: 0, y: -15, scale: 0.99 }} // Smoother, slower lift on exit
//           transition={{ duration: 0.5, ease: [0.4, 0, 0.2, 1] }} // Professional cubic-bezier ease
//           className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-background overflow-hidden select-none"
//         >
//           {/* Dynamic Ambient Background Glow */}
//           <div className="absolute inset-0 opacity-20 pointer-events-none overflow-hidden">
//             <div className="absolute -top-[10%] -left-[10%] w-[50vw] h-[50vw] rounded-full bg-primary/30 blur-[120px] animate-pulse" />
//             <div className="absolute -bottom-[10%] -right-[10%] w-[50vw] h-[50vw] rounded-full bg-secondary/30 blur-[120px] animate-pulse" />
//           </div>
...
//                   <motion.div
//                     key={i}
//                     className="absolute top-1/2 left-1/2 w-1.5 h-1.5 rounded-full bg-secondary"
...
//                     }}
//                     transition={{
//                       delay: 1.4, // Fires comfortably mid-way through presentation
//                       duration: 0.7,
//                       ease: "easeOut",
//                     }}
//                   />
...
//               {/* Animated SVG Logo */}
//               <motion.svg
//                 className="w-24 h-24 text-primary filter drop-shadow-[0_0_15px_rgba(var(--primary-rgb),0.3)]"
//                 viewBox="0 0 62 78"
//                 fill="none"
...
//                 animate="visible"
//               >
//                 {/* CRITICAL CHANGE: Changed fill to none initially, added a stroke,
//                   and set smooth rounded stroke joints for a "drawn" texture.
//                 */}
//                 <g
//                   fill="currentColor"
//                   stroke="currentColor"
...
//             <h1 className="text-3xl md:text-4xl font-black tracking-widest text-foreground mb-6 flex select-none overflow-hidden h-12 items-center justify-center">
...
//                   transition={{
//                     delay: 0.5 + index * 0.06, // Slightly relaxed layout pace
//                     type: "spring",
//                     stiffness: 120,
//                     damping: 18,
//                   }}
//                   className="inline-block"
//                   style={{ minWidth: letter === " " ? "0.6em" : "auto" }}
//                 >
//                   {letter === " " ? "\u00A0" : letter}
//                 </motion.span>
//               ))}
...
//             <div className="w-32 h-[3px] bg-muted/30 rounded-full overflow-hidden relative">
//               <motion.div
//                 className="absolute top-0 bottom-0 left-0 bg-gradient-to-r from-primary to-secondary rounded-full"
//                 initial={{ left: "-100%", right: "100%" }}
//                 animate={{ left: "0%", right: "0%" }}
//                 transition={{
//                   delay: 0.2,
//                   duration: 2.3, // Matches total load feeling right up to the fadeout
//                   ease: [0.65, 0, 0.35, 1],
//                 }}
//               />
//             </div>
