...
const Logo = () => {
  return (
    ...
    >
      ...
      <div className="relative flex items-bottom justify-center w-10 h-10 md:w-12 md:h-12 rounded-full bg-transparent text-foreground transition-transform duration-500 group-hover:-rotate-6 group-hover:scale-110">
