...
// 1. Create an isolated internal cache execution context
const getCachedVideoSources = (type) =>
  unstable_cache(
...
// 2. Export a clean async function entrypoint for Turbopack bundle static analysis
